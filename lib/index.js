...
function _new(obj) {
  ...
  let _factory = obj.init || (obj.extensions[obj.extensions.length - 1] || {}).init;

  const _extensions = [];

  while (_factory) {
    const _retval = _factory && _factory.apply(target, Array.prototype.slice.call(arguments, 1));

    if (Object.prototype.toString.call(_retval) === '[object Object]') {
  ...
  mergeDefinitionsInto.call(target, target, {
