...
function _combine(ctx, data, parent) {
  ...
  if (parent) {
    ...
    hiddenProperty(ctx, 'init', parent.init);
    hiddenProperty(ctx, 'props', _reduce(parent.props, data.props));
    hiddenProperty(ctx, 'methods', _reduce(parent.methods, data.methods));
  }
